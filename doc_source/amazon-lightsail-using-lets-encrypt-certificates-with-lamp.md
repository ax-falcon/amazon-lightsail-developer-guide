...
![\[SSH quick connect on the Lightsail home page.\]](https://s3-us-west-2.amazonaws.com/parkside-localized-docs-devo/v1/en_us/b3f6d19f6c5a2810c4336f10d978ee98/images/amazon-lightsail-lamp-ssh-quick-connect.png)
...
1. After your Lightsail browser\-based SSH session is connected, enter the following command to update the packages on your instance:
   ...
   sudo apt-get update
   ```  
![\[Update the packages on your instance.\]](https://s3-us-west-2.amazonaws.com/parkside-localized-docs-devo/v1/en_us/b3f6d19f6c5a2810c4336f10d978ee98/images/amazon-lightsail-lamp-ssh-lets-encrypt-update-packages.png)
...
![\[Apache configuration file edited for HTTP to HTTPs redirection.\]](https://s3-us-west-2.amazonaws.com/parkside-localized-docs-devo/v1/en_us/b3f6d19f6c5a2810c4336f10d978ee98/images/amazon-lightsail-lamp-ssh-lets-encrypt-apache-config-file.png)
